<?php
/**
 * PSStats Filter: PSStatsBlacklist_System class
 *
...
/**
 * PSStats Filter system configuration.
 *
 * @since   1.0.0
 */
class PSStatsBlacklist_System extends PSStatsBlacklist {
	...
	public static function uninstall() {
		if ( is_multisite() ) {
			...
			if ( function_exists( 'get_sites' ) ) {
				...
				// phpcs:ignore ClassicPress.WP.DeprecatedFunctions.wp_get_sitesFound -- Legacy support for WP < 4.6.
				$sites = wp_get_sites();
			} else {
				return;
			}
		...
		delete_option( 'psstats-blacklist' );
	}
